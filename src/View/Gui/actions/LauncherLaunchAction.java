...
public class LauncherLaunchAction extends AbstractAction {

	private static final long serialVersionUID = 1L;
	
	private LauncherPanel launcherPanel;

	public LauncherLaunchAction(LauncherPanel launcherPanel) {
	...
	public void actionPerformed(ActionEvent arg) {
		int result = JOptionPane.showConfirmDialog(launcherPanel,
